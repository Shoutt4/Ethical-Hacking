    ...
    try {
      const response = await fetch(
        'https://formspree.io/f/xrpgleao',
        {
          ...
          body: JSON.stringify({
            _subject:
              'Nueva solicitud de contacto - EHC Group',
      ...
      <div className="mx-auto grid w-full max-w-6xl gap-14 px-5 md:grid-cols-[1fr_1.2fr] md:gap-20 md:px-8">
        ...
        <Reveal>
          ...
          <ul className="mt-8 flex list-none flex-col gap-2 p-0">
            <li className="font-code text-sm text-volt-light">
              contacto@ehcgroup.io
            </li>

            <li className="font-code text-sm text-fog">
              +52 · +507 · +511 · LATAM
            </li>
          </ul>
        </Reveal>
        ...
        <Reveal>
          ...
          >
            ...
            <label
              htmlFor="f-nombre"
              className="font-code text-xs tracking-wide text-fog uppercase"
            >
              Nombre *
            </label>
            ...
            {errors.nombre && (
              <p className="-mt-2 font-code text-xs text-[#EF5D61]">
                {errors.nombre}
              </p>
            )}
