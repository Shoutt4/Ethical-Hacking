...
export default function Partners() {
  ...
  return (
    <section
      ...
      className="trust-clip relative scroll-mt-24 bg-[#f7f8f5] py-20 md:py-24"
    >
      <span
        aria-hidden="true"
      ...
      <div className="relative mx-auto w-full max-w-7xl px-5 pt-2 pb-1 md:px-8">
        <Reveal>
          <h2 className="font-display text-[clamp(1.9rem,3.6vw,3.2rem)] leading-[.96] tracking-[-.035em] text-[#071117]">
      ...
      <div
        className="relative mx-auto mt-12 w-full max-w-7xl overflow-hidden"
        style={{
          maskImage:
